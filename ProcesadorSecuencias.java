...
public class ProcesadorSecuencias extends Application
{
	...
	public void start(Stage primaryStage)
	{
	    ...
	    tfSecuencia1.setPrefColumnCount(22);
	    tfSecuencia2.setPrefColumnCount(22);
		...
		hbox2.getChildren().addAll(btMostrar, btSumar, btRestar, btMultiplicar, btAmplificar, btDesplazar, btReflejar, btDiezmar, btInterpolar, btConvolucion);
			...
			e -> 
			{
				if(rbSecuencia1.isSelected())
				{
					...
					for(String s: array1)
					{
						if(i == origen)
						{
							x.add(new Par(0, Integer.parseInt(array1[i])));
							i++;
						}
						else
						{
							x.add(new Par(-1, Integer.parseInt(array1[i])));
							i++;
						}
					}
				...
				else if(rbSecuencia2.isSelected())
				{
					...
					for(String s: array2)
					{
						if(i == origen)
						{
							y.add(new Par(0, Integer.parseInt(array2[i])));
							i++;
						}
						else
						{
							y.add(new Par(-1, Integer.parseInt(array2[i])));
							i++;
						}
					}
					//Colocando sus posiciones	
